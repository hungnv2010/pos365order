...
+ (PrinterManager *)sharedInstance{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _sharedInstance.CurrentPrinterPortType = PrinterPortWifi;
        _sharedInstance.CurrentPrinterCmdType = PrinterCmdESC;
...
-(NSData *) GetHeaderCmd:(Cmd *)cmd cmdtype:(PrinterCmdType)cmdtype{
    ...
    if (cmdtype==PrinterCmdTSC || cmdtype==PrinterCmdCPCL ||  cmdtype==PrinterCmdZPL){
        ...
        lblcommSetting.labelWidth = 100;
        lblcommSetting.labelHeight = 50;
        lblcommSetting.labelgap = 0;//3 for Tsc,cpcl
        lblcommSetting.labelDriection = Direction_Forward;
        lblcommSetting.Density = 7;
